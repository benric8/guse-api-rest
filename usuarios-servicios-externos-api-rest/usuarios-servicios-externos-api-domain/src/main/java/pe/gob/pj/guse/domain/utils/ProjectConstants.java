...
public class ProjectConstants {
	...
	public static final String APLICATIVO_NOMBRE = "usuarios-servicios-externos-api";
	public static final String APLICATIVO_VERSION = "1.0.0";
	
	public class Esquema {
		public static final String SIDENUM = "USRSIDENUM";
	...
	public static final String ALFRESCO_VERSION_4_2 = "4.2";
	
	public static final String ORIGEN_RESOLUCION_FTP = "F";
	public static final String ORIGEN_RESOLUCION_ALFRESCO = "A";
	public static final String ORIGEN_RESOLUCION_BASE_DATOS = "B";
	

	public static final String RENIEC_TIPO_BUSQUEDA_DNI = "2";
	public static final String RENIEC_USUARIO_CONSULTA_DEFAULT = "uc_usuarios-servicios-externos";
