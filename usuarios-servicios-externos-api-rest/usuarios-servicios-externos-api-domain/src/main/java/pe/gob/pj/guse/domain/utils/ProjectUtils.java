...
public class ProjectUtils {
	...
	public static java.sql.Date parseStringToSQLDate(String fechaString, String formatUtilDate, String formatSQLDate) throws Exception {
		SimpleDateFormat formatUtil = new SimpleDateFormat(formatUtilDate,new Locale("es", "ES"));
		try {
			Date utilDate = formatUtil.parse(fechaString);
			SimpleDateFormat formatSQL = new SimpleDateFormat(formatSQLDate,new Locale("es", "ES"));
			String stringSqlDate = formatSQL.format(utilDate);
			java.sql.Date sqlDate = java.sql.Date.valueOf(stringSqlDate);
			return sqlDate;
		} catch (ParseException e) {
			throw new Exception(ProjectConstants.Mensajes.MSG_ERROR_GENERICO_CONVERSION + " [" + e.getMessage() + "]");
		}
	...
	public static java.sql.Date parseDateToSQLDate(Date fechaDate, String formatSQLDate) throws Exception {
		SimpleDateFormat formatSQL = new SimpleDateFormat(formatSQLDate,new Locale("es", "ES"));
		String stringSqlDate = formatSQL.format(fechaDate);
		java.sql.Date sqlDate = java.sql.Date.valueOf(stringSqlDate);
		return sqlDate;
	}

	public static java.sql.Timestamp parseStringToSQLTimestamp(String fechaString, String formatUtilDate, String formatSQLTimestamp) throws Exception {
		SimpleDateFormat formatUtil = new SimpleDateFormat(formatUtilDate,new Locale("es", "ES"));
		try {
			Date utilDate = formatUtil.parse(fechaString);
			SimpleDateFormat formatSQL = new SimpleDateFormat(formatSQLTimestamp, new Locale("es", "ES"));
			String stringSqlDate = formatSQL.format(utilDate);
			java.sql.Timestamp sqlTimestamp = java.sql.Timestamp.valueOf(stringSqlDate);
			return sqlTimestamp;
		} catch (ParseException e) {
			throw new Exception(ProjectConstants.Mensajes.MSG_ERROR_GENERICO_CONVERSION + " [" + e.getMessage() + "]");
		}
	...
	public static java.sql.Timestamp parseDateToSQLTimestamp(Date fechaDate, String formatSQLTimestamp) throws Exception {
		SimpleDateFormat formatSQL = new SimpleDateFormat(formatSQLTimestamp, new Locale("es", "ES"));
		String stringSqlDate = formatSQL.format(fechaDate);
		java.sql.Timestamp sqlTimestamp = java.sql.Timestamp.valueOf(stringSqlDate);
		return sqlTimestamp;
	...
	public static boolean esFechaValida(String dateToValidate, String dateFormat) {
		...
		SimpleDateFormat sdf = new SimpleDateFormat(dateFormat,new Locale("es", "ES"));
	...
	public static String obtenerCodigoUnico() {
		...
		SimpleDateFormat formato = new SimpleDateFormat("yyyyMMddHHmmssSSSSSS",new Locale("es", "ES"));
	...
	public static java.sql.Date getSqlDate(String fecha) throws Exception {
		...
		try {
			...
			java.text.SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd",new Locale("es", "ES"));
	...
	public static java.sql.Date getSqlDateFull(String fecha) throws Exception {
		SimpleDateFormat format = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss",new Locale("es", "ES"));
		try {
			java.util.Date aDate = format.parse(fecha);
			java.text.SimpleDateFormat sdf = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss",new Locale("es", "ES"));
			java.sql.Date sqlDate = java.sql.Date.valueOf(sdf.format(aDate));
			return sqlDate;
		} catch (ParseException e) {
			throw new Exception(ProjectConstants.Mensajes.MSG_ERROR_GENERICO_CONVERSION + " [" + e.getMessage() + "]");
	...
	public static Date getSqlDateFullDos(String fecha) throws Exception {
		SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss.SSS",new Locale("es", "ES"));
		try {
			java.util.Date aDate = format.parse(fecha);
			return aDate;
		} catch (ParseException e) {
