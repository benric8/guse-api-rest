...
public class CMISManagerImpl implements CMISManager {
    ...
    public CMISManagerImpl(String cuo, String host, String puerto, String usuario, String clave, String path, String version){
    	this.cuo = cuo;
    	credencialesConexion.put(SessionParameter.ATOMPUB_URL, "http://"+ host +":"+ puerto +"/" + (version.equals(ProjectConstants.ALFRESCO_VERSION_4_2)?this.atompubUrl42 : this.atompubUrl41));
