...
import pe.gob.pj.guse.domain.utils.crypt.Base64u;
...
public class EncryptUtils {
	...
	private static final char[] PASSWORD =  ProjectProperties.getInstance().getSeguridadSecretToken().toCharArray(); //PropertyConstantes.Propiedades.Seguridad.SECRET_TOKEN.toCharArray();
