package pe.gob.pj.guse.infraestructure.rest.exceptions;
...
public class CustomGlobalExceptionHandler extends ResponseEntityExceptionHandler {
	...
	protected ResponseEntity<Object> handleHttpMediaTypeNotSupported(
		...
		body.put("codigo", ProjectConstants.C_ERROR+status.value());
...
//		body.put("error", errors);
		...
		body.put("codigo", ProjectConstants.C_ERROR+HttpStatus.NOT_FOUND);
		body.put("descripcion", errors);
		body.put("codigoOperacion", cuo.substring(1, cuo.length()-1));
		body.put("data", null);
		log.error("{} {}",cuo , errors);
	...
	public ResponseEntity<Object> handleAll(Exception ex, WebRequest request) {
		String cuo = String.valueOf(request.getAttribute(ProjectConstants.AUD_CUO, SCOPE_REQUEST));
		Map<String, Object> body = new LinkedHashMap<>();
		body.put("codigo", ProjectConstants.C_ERROR+HttpStatus.INTERNAL_SERVER_ERROR.toString().substring(0, 4));
		StringBuilder builder = new StringBuilder();
		...
		body.put("codigoOperacion", cuo.substring(1, cuo.length()-1));
		body.put("data", null);
		log.error("{} {}",cuo,builder.toString());
